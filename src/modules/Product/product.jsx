	...
	render(){
		const proData = {
			IOT:{
				...
				title:'物联网产品\n物联网产品\n物联网产品\n物联网产品\nPCISSI数据采集\n物联网产品',
				introduce:'杭州钛比科技专注于SSI数据采集解决方案，\m专业研发定制基于串口、PCI、cPCI、USB和以太网接口的SSI编码器数据采集板卡。适配所有支持标准SSI协议的编码器，性能稳定、应用广泛，同时可以定制实现客户的特殊需求。杭州钛比科技专注于SSI数据采集解决方案多年，技术实力超群，在客户中拥有极佳的口碑。\n测试123\n测试456'
			},	
			ISS:{
